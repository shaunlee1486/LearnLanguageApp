...
{
    /// <inheritdoc />
    public partial class Phase7_SM2_Streaks : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Character = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    StrokeCount = table.Column<int>(type: "integer", nullable: false),
                    VietnameseMeaning = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VietnameseMeaning = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ModifiedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RadicalExamples", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RadicalExamples_Radicals_RadicalId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    GrammarRuleId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveLanguageId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ModifiedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Languages_ActiveLanguageId",
                        column: x => x.ActiveLanguageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewLists_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewLists_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VietnameseMeaning = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    LanguageId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SentenceStructures_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SentenceStructures_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConfigSnapshot = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IPA = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    ...
                    EasyFactor = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "SentenceStructureExamples",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SentenceStructureId = table.Column<Guid>(type: "uuid", nullable: false),
                    Sentence = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SentenceStructureExamples", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SentenceStructureExamples_SentenceStructures_SentenceStruct~",
                        column: x => x.SentenceStructureId,
            ...
            migrationBuilder.CreateTable(
                name: "ReviewListWords",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ReviewListId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewListWords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewListWords_ReviewLists_ReviewListId",
                        column: x => x.ReviewListId,
                        principalTable: "ReviewLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewListWords_Words_WordId",
                        column: x => x.WordId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    WordId = table.Column<Guid>(type: "uuid", nullable: false),
                    TypeOfWord = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    MeaningText = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ModifiedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GrammarRules_LanguageId",
                table: "GrammarRules",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_GrammarRules_UserId",
                table: "GrammarRules",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RadicalExamples_RadicalId",
                table: "RadicalExamples",
                column: "RadicalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewLists_LanguageId",
                table: "ReviewLists",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewLists_UserId_LanguageId",
                table: "ReviewLists",
                columns: new[] { "UserId", "LanguageId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReviewListWords_ReviewListId_WordId",
                table: "ReviewListWords",
                columns: new[] { "ReviewListId", "WordId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReviewListWords_WordId",
                table: "ReviewListWords",
                column: "WordId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SentenceStructureExamples_SentenceStructureId",
                table: "SentenceStructureExamples",
                column: "SentenceStructureId");

            migrationBuilder.CreateIndex(
                name: "IX_SentenceStructures_LanguageId",
                table: "SentenceStructures",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_SentenceStructures_UserId",
                table: "SentenceStructures",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_ActiveLanguageId",
                table: "Users",
                column: "ActiveLanguageId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_GrammarRules_Languages_LanguageId",
                table: "GrammarRules",
                column: "LanguageId",
                principalTable: "Languages",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_GrammarRules_Users_UserId",
                table: "GrammarRules",
                column: "UserId",
                principalTable: "Users",
                principalColumn: "Id",
